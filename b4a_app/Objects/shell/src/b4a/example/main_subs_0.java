...
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 32;BA.debugLine="StartActivity(aLIST)";
Debug.ShouldStop(-2147483648);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((main.mostCurrent._alist.getObject())));
...
alist_subs_0._process_globals();
atambah_subs_0._process_globals();
multipartpost_subs_0._process_globals();
aedit_subs_0._process_globals();
httputils2service_subs_0._process_globals();
main.myClass = BA.getDeviceClass ("b4a.example.main");
starter.myClass = BA.getDeviceClass ("b4a.example.starter");
alist.myClass = BA.getDeviceClass ("b4a.example.alist");
atambah.myClass = BA.getDeviceClass ("b4a.example.atambah");
multipartpost.myClass = BA.getDeviceClass ("b4a.example.multipartpost");
aedit.myClass = BA.getDeviceClass ("b4a.example.aedit");
