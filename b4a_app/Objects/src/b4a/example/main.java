...
vis = vis | (alist.mostCurrent != null);
vis = vis | (atambah.mostCurrent != null);
vis = vis | (aedit.mostCurrent != null);
return vis;}
...
BA.applicationContext.stopService(new android.content.Intent(BA.applicationContext, starter.class));
 {
            Activity __a = null;
            if (alist.previousOne != null) {
				__a = alist.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(alist.mostCurrent == null ? null : alist.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (atambah.previousOne != null) {
				__a = atambah.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(atambah.mostCurrent == null ? null : atambah.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (aedit.previousOne != null) {
				__a = aedit.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(aedit.mostCurrent == null ? null : aedit.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
...
RDebugUtils.currentLine=196609;
 //BA.debugLineNum = 196609;BA.debugLine="StartActivity(aLIST)";
